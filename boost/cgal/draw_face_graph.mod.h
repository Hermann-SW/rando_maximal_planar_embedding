#ifndef CGAL_DRAW_FACE_GRAPH_MOD_H
#define CGAL_DRAW_FACE_GRAPH_MOD_H
...
//    SimpleFaceGraphViewerQt(parent, g, title, anofaces, DefaultColorFunctorFaceGraph())
    // First draw: no vertex; edges, faces; no mono-color; no inverse normal
    Base(parent, title, false, true, true, false, true),
    m_compute_elements_impl(compute_elements_functor(g, anofaces, DefaultColorFunctorFaceGraph()))
  {
  }
...
#endif // CGAL_DRAW_FACE_GRAPH_MOD_H
